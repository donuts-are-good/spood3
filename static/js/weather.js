(function(){
  ...
  if (data.weekly) {
    ...
    set('kv-biome', w.biome); set('kv-pizza', w.pizza_selection); set('kv-off', w.casino_officials);
  }
  if (data.today) {
    const t = data.today; const set=(id,v)=>{const el=document.getElementById(id); if(el) el.textContent=v||'—'};
    set('kv-cheese', t.cheese_smell); set('kv-time', t.time_mode);
  }
